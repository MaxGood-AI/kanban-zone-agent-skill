...
from kanban_zone import legacy as kanban_zone_legacy
...
class TestOrgRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_org.register)

    def test_org_me_is_parseable(self):
        args = self.parser.parse_args(["org", "me"])
        self.assertEqual(args.func, kanban_zone_org.cmd_me)
...
class TestBoardsRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_boards.register)

    def test_boards_list_is_parseable(self):
        args = self.parser.parse_args(["boards", "list"])
        self.assertEqual(args.func, kanban_zone_boards.cmd_list)
    ...
    def test_boards_get_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_boards.cmd_get)
        self.assertFalse(args.include_columns)
        self.assertFalse(args.include_members)
        self.assertFalse(args.include_labels)
        self.assertFalse(args.include_custom_fields)
...
class TestCardsRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_cards.register)

    def test_cards_list_is_parseable(self):
        args = self.parser.parse_args(["cards", "list"])
        self.assertEqual(args.func, kanban_zone_cards.cmd_list)
    ...
    def test_cards_metrics_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_cards.cmd_metrics)

    def test_cards_create_is_parseable(self):
        args = self.parser.parse_args(["cards", "create", "--title", "New Card"])
        self.assertEqual(args.func, kanban_zone_cards.cmd_create)
...
class TestCommentsRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_comments.register)

    def test_comments_add_is_parseable(self):
        args = self.parser.parse_args(["comments", "add", "--card", "42", "--text", "hi"])
        self.assertEqual(args.func, kanban_zone_comments.cmd_add)
    ...
    def test_comments_list_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_comments.cmd_list)


class TestChecklistsRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_chk.register)

    def test_checklists_create_is_parseable(self):
        args = self.parser.parse_args([
            "checklists", "create", "--card", "42", "--title", "QA",
        ])
        self.assertEqual(args.func, kanban_zone_chk.cmd_create)
    ...
    def test_checklists_update_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_chk.cmd_update)
    ...
    def test_checklists_delete_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_chk.cmd_delete)

    def test_checklists_list_is_parseable(self):
        args = self.parser.parse_args(["checklists", "list", "--card", "42"])
        self.assertEqual(args.func, kanban_zone_chk.cmd_list)


class TestTasksRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_tasks.register)

    def test_tasks_create_is_parseable(self):
        args = self.parser.parse_args([
            "tasks", "create", "--checklist", "CHK1", "--description", "Do X",
        ])
        self.assertEqual(args.func, kanban_zone_tasks.cmd_create)
    ...
    def test_tasks_update_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_tasks.cmd_update)
    ...
    def test_tasks_delete_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_tasks.cmd_delete)
    ...
    def test_tasks_move_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_tasks.cmd_move)
...
class TestTokensRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_tokens.register)

    def test_tokens_assign_is_parseable(self):
        args = self.parser.parse_args([
            "tokens", "assign", "--card", "42", "--token-id", "TKN1",
        ])
        self.assertEqual(args.func, kanban_zone_tokens.cmd_assign)
        self.assertEqual(args.card, "42")
...
class TestWebhooksRegister(unittest.TestCase):
    ...
    def test_webhooks_create_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_webhooks.cmd_create)
    ...
    def test_webhooks_verify_signature_is_parseable(self):
        ...
        self.assertEqual(args.func, kanban_zone_webhooks.cmd_verify_signature)
...
class TestReportsRegister(unittest.TestCase):
    def setUp(self):
        self.parser, self.sub = _make_parser(kanban_zone_reports.register)
...
class TestLegacyRegister(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from kanban_zone import boards as _b, cards as _c
        self.parser = argparse.ArgumentParser()
        sub = self.parser.add_subparsers(dest="group")
        _b.register(sub)
        _c.register(sub)
        kanban_zone_legacy.register(sub)
        self.sub = sub
    ...
    def test_wrap_boards_list_defaults(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_boards_list(
    ...
    def test_wrap_cards_list_fills_defaults(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_list(_MinArgs(), ctx)
    ...
    def test_wrap_cards_get_copies_number_to_id(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_get(args, ctx)
    ...
    def test_wrap_cards_create_calls_cmd_create(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_create(args, ctx)
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with FakeApi() as fake:
                ...
                with patch("sys.stdout", io.StringIO()):
                    ...
                    kanban_zone_legacy._wrap_cards_create_bulk(args, ctx)
    ...
    def test_wrap_cards_update_converts_id(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_update(args, ctx)
    ...
    def test_wrap_cards_move(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_move(args, ctx)
    ...
    def test_wrap_cards_links_add(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_links_add(args, ctx)
    ...
    def test_wrap_cards_links_remove(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_links_remove(args, ctx)
    ...
    def test_wrap_cards_search(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                ...
                kanban_zone_legacy._wrap_cards_search(args, ctx)
    ...
    def test_wrap_cards_wip_check(self):
        ...
        with FakeApi() as fake:
            ...
            with patch("sys.stdout", io.StringIO()):
                args = type("A", (), {})()
                kanban_zone_legacy._wrap_cards_wip_check(args, ctx)
